...
export class AppComponent {
  ...
  public casasHogar: CasaHogar[] = [
    ...
    { nombre: 'Casa hogar los angelitos .', lat: 32.46040384232971, lng: -116.93056589158908 },
    ...
    centrarEnCasa(casa: CasaHogar) {
      console.log('Centrar desde AppComponent:', casa);
      if (this.mapaComponent) {
        this.mapaComponent.centrarEnCasa(casa);
      }
    }
